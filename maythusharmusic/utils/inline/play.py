...
return [
[
InlineKeyboardButton(text=["P_B_1"], callback_data=f"MusicStream {videoid}|{user_id}|a|{channel}|{fplay}"),
InlineKeyboardButton(text=["P_B_2"], callback_data=f"MusicStream {videoid}|{user_id}|v|{channel}|{fplay}"),
],
[
InlineKeyboardButton(text=["CLOSE_BUTTON"], callback_data=f"forceclose {videoid}|{user_id}"),
],
]
...
InlineKeyboardButton(text=["CLOSE_BUTTON"], callback_data=f"forceclose {query}|{user_id}"),
